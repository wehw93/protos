...
type RegisterResponce struct {
	...
	UserId int64 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // User ID of the regesterd user
}
...
func (x *LoginRequset) GetAppId() int32 {
	if x != nil {
		return x.AppId
	}
	return 0
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x61, 0x75, 0x74, 0x68, 0x2e, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x73, 0x65,
	...
	0x5a, 0x11, 0x77, 0x65, 0x68, 0x77, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b, 0x73, 0x73,
...
var file_sso_sso_proto_goTypes = []interface{}{
	...
	(*LoginRequset)(nil),     // 2: auth.LoginRequset
...
var file_sso_sso_proto_depIdxs = []int32{
	...
	2, // 1: auth.Auth.Login:input_type -> auth.LoginRequset

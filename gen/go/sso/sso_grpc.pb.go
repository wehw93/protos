...
type AuthClient interface {
	...
	Login(ctx context.Context, in *LoginRequset, opts ...grpc.CallOption) (*LoginResponce, error)
...
func (c *authClient) Login(ctx context.Context, in *LoginRequset, opts ...grpc.CallOption) (*LoginResponce, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AuthServer interface {
	...
	Login(context.Context, *LoginRequset) (*LoginResponce, error)
...
func (UnimplementedAuthServer) Login(context.Context, *LoginRequset) (*LoginResponce, error) {
...
func _Auth_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).Login(ctx, req.(*LoginRequset))
	}
	return interceptor(ctx, in, info, handler)
}
